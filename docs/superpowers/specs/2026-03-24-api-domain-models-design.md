...
4. Использование enum для строгой типизации (TSType)
5. Правильный маппинг между слоями
6. Оркестрация бизнес-логики через UseCase
7. Чистая архитектура без смешения слоев
